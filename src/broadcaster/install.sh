...
if [ ! -f .env ]; then
	...
	echo "What is the IP or hostname of the Overseer server? (e.g. https://example.com or http://192.168.1.150)"
	read overseer_host
	...
	curl -sf -H "Authorization: Bearer ${overseer_token}" "$overseer_host/broadcaster/verify" > /dev/null
